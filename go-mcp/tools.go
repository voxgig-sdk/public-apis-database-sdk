...
type Args struct {
	Entity string         `json:"entity" jsonschema:"ap_i"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.PublicApisDatabaseSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "public-apis-database_list",
		Description: "List records from PublicApisDatabase. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "public-apis-database_load",
		Description: "Load a single record from PublicApisDatabase. " +
...
func runOp(client *sdk.PublicApisDatabaseSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PublicApisDatabaseSDK, name string) (sdk.PublicApisDatabaseEntity, error) {
