...
function runner.env_override(m)
  local live = runner.getenv("PUBLICAPISDATABASE_TEST_LIVE")
  local override = runner.getenv("PUBLICAPISDATABASE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PUBLICAPISDATABASE_TEST_EXPLAIN")
