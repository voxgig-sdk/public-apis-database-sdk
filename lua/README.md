...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/public-apis-database-sdk/releases)),
...
```
lua/
├── public-apis-database_sdk.lua    -- Main SDK module
...
The main module (`public-apis-database_sdk`) exports the SDK constructor
