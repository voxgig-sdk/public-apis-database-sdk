# PublicApisDatabase TypeScript SDK
...
```ts
new PublicApisDatabaseSDK(options?: {
  base?: string
  prefix?: string
  suffix?: string
...
| Method | Returns | Description |
| --- | --- | --- |
| `PublicApisDatabaseSDK.test(testopts?, sdkopts?)` | `PublicApisDatabaseSDK` | Create a test-mode client. |
...
| `client` | `client(): PublicApisDatabaseSDK` | Return the parent SDK client. |
...
├── src/
│   ├── PublicApisDatabaseSDK.ts        # Main SDK class
