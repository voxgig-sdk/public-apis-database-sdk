...
(0, node_test_1.describe)('ApIEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.PublicApisDatabaseSDK.test();
...
function basicSetup(extra) {
    ...
    let client = __1.PublicApisDatabaseSDK.test(options, extra);
    ...
    if (live) {
        ...
        client = new __1.PublicApisDatabaseSDK(merge([
