...
function envOverride(m) {
    if ('TRUE' === process.env.PUBLIC_APIS_DATABASE_TEST_LIVE ||
        'TRUE' === process.env.PUBLIC_APIS_DATABASE_TEST_OVERRIDE) {
    ...
    m.PUBLIC_APIS_DATABASE_TEST_EXPLAIN = process.env.PUBLIC_APIS_DATABASE_TEST_EXPLAIN || m.PUBLIC_APIS_DATABASE_TEST_EXPLAIN;
    return m;
}
