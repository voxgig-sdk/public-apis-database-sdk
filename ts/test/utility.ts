...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.PUBLICAPISDATABASE_TEST_LIVE ||
    'TRUE' === process.env.PUBLICAPISDATABASE_TEST_OVERRIDE
  ) {
  ...
  m.PUBLICAPISDATABASE_TEST_EXPLAIN = process.env.PUBLICAPISDATABASE_TEST_EXPLAIN || m.PUBLICAPISDATABASE_TEST_EXPLAIN
