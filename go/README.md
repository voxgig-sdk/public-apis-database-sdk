...
## Install
```bash
go get github.com/voxgig-sdk/public-apis-database-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/public-apis-database-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/public-apis-database-sdk/go=../public-apis-database-sdk/go
```
...
import (
    "fmt"
    sdk "github.com/voxgig-sdk/public-apis-database-sdk/go"
)
...
client := sdk.NewPublicApisDatabaseSDK(map[string]any{
...
```
PUBLIC_APIS_DATABASE_TEST_LIVE=TRUE
```
...
All entities implement the `PublicApisDatabaseEntity` interface.
...
```
github.com/voxgig-sdk/public-apis-database-sdk/go/
├── public-apis-database.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/public-apis-database-sdk/go`) re-exports everything needed
