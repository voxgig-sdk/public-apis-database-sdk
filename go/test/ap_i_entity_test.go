...
func TestApIEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		apIRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.ap_i")))
...
func ap_iBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("PUBLIC_APIS_DATABASE_TEST_AP_I_ENTID")
	...
	idmapResolved := core.ToMapAny(env["PUBLIC_APIS_DATABASE_TEST_AP_I_ENTID"])
