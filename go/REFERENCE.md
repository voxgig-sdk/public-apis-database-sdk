# PublicApisDatabase Golang SDK Reference

Complete API reference for the PublicApisDatabase Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *PublicApisDatabaseSDK`
