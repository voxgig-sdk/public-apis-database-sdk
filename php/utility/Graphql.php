...
// PublicApisDatabase SDK utility: graphql
//
...
class PublicApisDatabaseGraphql
{
    ...
    // equivalent.
    public static function body(PublicApisDatabaseContext $ctx): mixed
    {
    ...
    public static function errors(PublicApisDatabaseContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
