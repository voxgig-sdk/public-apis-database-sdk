...
// PublicApisDatabase SDK timeout feature
...
class PublicApisDatabaseTimeoutFeature extends PublicApisDatabaseBaseFeature
{
    ...
    private function _with_timeout(PublicApisDatabaseContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PublicApisDatabaseContext $_ctx, float $ms): void
    {
        $client = $this->client;
