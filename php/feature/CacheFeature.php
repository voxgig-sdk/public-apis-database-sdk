...
// PublicApisDatabase SDK cache feature
...
class PublicApisDatabaseCacheFeature extends PublicApisDatabaseBaseFeature
{
    ...
    private function _through(PublicApisDatabaseContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
