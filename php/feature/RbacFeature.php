...
// PublicApisDatabase SDK rbac feature
...
class PublicApisDatabaseRbacFeature extends PublicApisDatabaseBaseFeature
{
    ...
    private function _required(PublicApisDatabaseContext $ctx): ?string
    {
    ...
    private function _reject(PublicApisDatabaseContext $ctx, string $required): void
    {
    ...
    private function _track(PublicApisDatabaseContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
