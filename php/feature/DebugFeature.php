...
// PublicApisDatabase SDK debug feature
...
class PublicApisDatabaseDebugFeature extends PublicApisDatabaseBaseFeature
{
    ...
    private function _finish(PublicApisDatabaseContext $ctx, bool $ok): void
    {
