...
// PublicApisDatabase SDK ratelimit feature
...
class PublicApisDatabaseRatelimitFeature extends PublicApisDatabaseBaseFeature
{
    ...
    private function _acquire(PublicApisDatabaseContext $ctx): void
    {
    ...
    private function _track(PublicApisDatabaseContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
