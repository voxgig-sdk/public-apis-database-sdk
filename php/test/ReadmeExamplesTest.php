...
// PublicApisDatabase SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PublicApisDatabaseSDK::test)
...
{
    private const SDK_CLASS = 'PublicApisDatabaseSDK';
    ...
    private const SDK_BASE = 'publicapisdatabase_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../publicapisdatabase_sdk.php';
