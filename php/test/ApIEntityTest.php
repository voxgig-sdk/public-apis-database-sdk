...
class ApIEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set PUBLICAPISDATABASE_TEST_AP_I_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function ap_i_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("PUBLICAPISDATABASE_TEST_AP_I_ENTID");
