...
// PublicApisDatabase SDK utility type

class PublicApisDatabaseUtility
{
    ...
    public static function copy(PublicApisDatabaseUtility $src): PublicApisDatabaseUtility
    {
        $u = new PublicApisDatabaseUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
