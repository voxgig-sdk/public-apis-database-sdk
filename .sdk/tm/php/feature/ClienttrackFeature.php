...
// PublicApisDatabase SDK clienttrack feature
...
class PublicApisDatabaseClienttrackFeature extends PublicApisDatabaseBaseFeature
{
    ...
    public function PostConstruct(PublicApisDatabaseContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'PublicApisDatabase-SDK';
