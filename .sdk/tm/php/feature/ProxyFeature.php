...
// PublicApisDatabase SDK proxy feature
...
class PublicApisDatabaseProxyFeature extends PublicApisDatabaseBaseFeature
{
    ...
    public function init(PublicApisDatabaseContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PublicApisDatabaseContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
