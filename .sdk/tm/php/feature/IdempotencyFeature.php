...
// PublicApisDatabase SDK idempotency feature
...
class PublicApisDatabaseIdempotencyFeature extends PublicApisDatabaseBaseFeature
{
    ...
    private function _mutating(PublicApisDatabaseContext $ctx): bool
    {
