...
// PublicApisDatabase SDK netsim feature
...
class PublicApisDatabaseNetsimFeature extends PublicApisDatabaseBaseFeature
{
    ...
    private function _simulate(PublicApisDatabaseContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PublicApisDatabaseContext $ctx, array $applied): void
    {
        $client = $this->client;
