...
// PublicApisDatabase SDK streaming feature
...
class PublicApisDatabaseStreamingFeature extends PublicApisDatabaseBaseFeature
{
    ...
    private function _iterate(PublicApisDatabaseResult $result): \Generator
    {
    ...
    private function _streamable(PublicApisDatabaseContext $ctx): bool
    {
