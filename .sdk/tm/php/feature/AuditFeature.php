...
// PublicApisDatabase SDK audit feature
...
class PublicApisDatabaseAuditFeature extends PublicApisDatabaseBaseFeature
{
    ...
    private function _emit(PublicApisDatabaseContext $ctx, string $outcome): void
    {
