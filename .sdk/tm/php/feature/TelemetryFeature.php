...
// PublicApisDatabase SDK telemetry feature
...
class PublicApisDatabaseTelemetryFeature extends PublicApisDatabaseBaseFeature
{
    ...
    private function _close(PublicApisDatabaseContext $ctx, bool $ok): void
    {
