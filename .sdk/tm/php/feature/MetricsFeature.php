...
// PublicApisDatabase SDK metrics feature
...
class PublicApisDatabaseMetricsFeature extends PublicApisDatabaseBaseFeature
{
    ...
    private function _record(PublicApisDatabaseContext $ctx, bool $ok): void
    {
