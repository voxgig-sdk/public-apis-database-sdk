...
// PublicApisDatabase SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class PublicApisDatabaseMakeRequest
{
    public static function call(PublicApisDatabaseContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new PublicApisDatabaseResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new PublicApisDatabaseResponse($fetched);
        } else {
