...
// PublicApisDatabase SDK utility: make_options

class PublicApisDatabaseMakeOptions
{
    ...
    public static function call(PublicApisDatabaseContext $ctx): array
    {
        ...
        //
        // `PublicApisDatabaseSchema::optspec()` is built from the model:
        ...
        $optspec = PublicApisDatabaseSchema::optspec();
