...
// PublicApisDatabase SDK utility: fetcher

class PublicApisDatabaseFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PublicApisDatabaseSDK/1.0)';
    ...
    public static function call(PublicApisDatabaseContext $ctx, string $fullurl, array $fetchdef): array
    {
