...
// PublicApisDatabase SDK utility: result_basic

class PublicApisDatabaseResultBasic
{
    public static function call(PublicApisDatabaseContext $ctx): ?PublicApisDatabaseResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof PublicApisDatabaseError) ? $result->err->msg : (string)$result->err;
