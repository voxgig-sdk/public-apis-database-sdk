...
|---|---|---|
| `ts/` | @voxgig-sdk/public-apis-database-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/public-apis-database-sdk \
      --repository voxgig-sdk/public-apis-database-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/public-apis-database-sdk` shows it, and
`npm trust revoke @voxgig-sdk/public-apis-database-sdk --id=<id>` removes it.
