...
func registerSDKWords(r *eng.Registry, client *sdk.PublicApisDatabaseSDK) {
...
func runOp(client *sdk.PublicApisDatabaseSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
