// Command PublicApisDatabase-cli is a CLI + REPL for the PublicApisDatabase SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      PUBLIC_APIS_DATABASE_APIKEY (api key), PUBLIC_APIS_DATABASE_BASE (base url override)")
