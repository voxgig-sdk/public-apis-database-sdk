...
- Releases: [https://github.com/voxgig-sdk/public-apis-database-sdk/releases](https://github.com/voxgig-sdk/public-apis-database-sdk/releases)
...
```ruby
require_relative "PublicApisDatabase_sdk"
client = PublicApisDatabaseSDK.new(options)
```
...
```ruby
client = PublicApisDatabaseSDK.test(testopts, sdkopts)
```
...
raise a `PublicApisDatabaseError` (a `StandardError` subclass), so wrap
...
```
rb/
├── PublicApisDatabase_sdk.rb       -- Main SDK module
...
The main module (`PublicApisDatabase_sdk`) exports the SDK class
