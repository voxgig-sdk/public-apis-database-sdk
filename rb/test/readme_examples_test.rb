...
#      offline in seeded test mode (PublicApisDatabaseSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "PublicApisDatabase_sdk.rb")
  SDK_CLASS = "PublicApisDatabaseSDK"
  ...
  SDK_BASE = "PublicApisDatabase_sdk"
