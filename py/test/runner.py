...
class PublicApisDatabaseTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PublicApisDatabaseTestRunner.getenv("PUBLICAPISDATABASE_TEST_LIVE")
        override = PublicApisDatabaseTestRunner.getenv("PUBLICAPISDATABASE_TEST_OVERRIDE")
        ...
        explain = PublicApisDatabaseTestRunner.getenv("PUBLICAPISDATABASE_TEST_EXPLAIN")
