# PublicApisDatabase SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PublicApisDatabaseSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PublicApisDatabaseSDK(...) and PublicApisDatabaseSDK.test(...) become
#      PublicApisDatabaseSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "publicapisdatabase_sdk"
_SDK_CLASS = "PublicApisDatabaseSDK"
