...
from publicapisdatabase_sdk.utility import register

# Load features
from publicapisdatabase_sdk.feature.base_feature import PublicApisDatabaseBaseFeature
from publicapisdatabase_sdk.features import _has_feature, _make_feature
...
class PublicApisDatabaseSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = PublicApisDatabaseUtility()
    ...
    def get_utility(self):
        return PublicApisDatabaseUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PublicApisDatabaseSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "PublicApisDatabaseSDK":
        if sdkopts is None:
            sdkopts = {}
