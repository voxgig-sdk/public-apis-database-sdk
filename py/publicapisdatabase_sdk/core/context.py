...
from publicapisdatabase_sdk.core.control import PublicApisDatabaseControl
...
from publicapisdatabase_sdk.core.helpers import get_ctx_prop, to_map
...
class PublicApisDatabaseContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = PublicApisDatabaseControl()
        ...
        if isinstance(sp, PublicApisDatabaseSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, PublicApisDatabaseResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, PublicApisDatabaseResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return PublicApisDatabaseOperation({})
        ...
        op = PublicApisDatabaseOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return PublicApisDatabaseError(code, msg, self)
