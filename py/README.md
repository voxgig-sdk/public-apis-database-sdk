...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/public-apis-database-sdk/releases)) or
...
```
py/
├── publicapisdatabase_sdk.py         -- Main SDK module
